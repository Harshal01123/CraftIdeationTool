          ...
          >
            ...
            <div className={styles.formLayout}>
              ...
              <div className={styles.leftColumn}>
                <h3 className={styles.sectionLabel}>{t("extended.courseDetails")}</h3>

                <div className={styles.fieldsContainer}>
                  {/* Course Name */}
                  <div className={styles.inputGroup}>
                    <label className={styles.inputLabel}>{t("extended.courseName")}</label>
                    <input
                      type="text"
                      required
                  ...
                  {/* Course Description */}
                  <div className={styles.inputGroup}>
                    <label className={styles.inputLabel}>{t("extended.courseDescription")}</label>
                    <textarea
                      required
                      className={styles.inputElement}
                  ...
                  <div className={styles.inputGroup}>
                    ...
                    <div style={{ position: "relative", overflow: "hidden", display: "inline-block", marginBottom: "0.5rem" }}>
                        ...
                        >
                          {(thumbnailPreview || thumbnail) && !isAutoThumbnail ? t("extended.replaceCustomThumbnail") : t("extended.uploadCustomThumbnail")}
                        </div>
                        <input
                          type="file"
                          accept="image/*"
                    ...
                    >
                      ...
                      {(thumbnailPreview || thumbnail) && (
                        <div style={{ position: "absolute", bottom: "0.5rem", right: "0.5rem", display: "flex", gap: "0.5rem" }}>
                           {isAutoThumbnail && (
                             <span style={{ backgroundColor: "rgba(0,0,0,0.6)", color: "white", padding: "0.25rem 0.5rem", borderRadius: "0.25rem", fontSize: "0.65rem", fontWeight: 700, textTransform: "uppercase" }}>{t("extended.autoGenerated")}</span>
                           )}
                           {!isAutoThumbnail && (
                             <button
                               type="button"
                  ...
                  <div className={styles.grid2Col}>
                    <div className={styles.inputGroup}>
                      ...
                      <div style={{ position: "relative" }}>
                        ...
                        >
                          <option value="Pottery">{t("industry.Pottery")}</option>
                          <option value="Bamboo">{t("industry.Bamboo")}</option>
                          <option value="Glass">{t("industry.Glass")}</option>
                          <option value="Tiles">{t("industry.Tiles")}</option>
                          <option value="Handloom">{t("industry.Handloom")}</option>
                          <option value="Painting">{t("industry.Painting")}</option>
                        </select>
                        <span
                    ...
                    <div className={styles.inputGroup}>
                      ...
                      <div style={{ position: "relative" }}>
                        ...
                        >
                          <option value="Beginner">{t("extended.beginner")}</option>
                          <option value="Intermediate">{t("extended.intermediate")}</option>
                          <option value="Advanced">{t("extended.master")}</option>
                        </select>
                        <span
                          className="material-symbols-outlined"
                          style={{
              ...
              <div className={styles.rightColumn}>
                <div className={styles.videoSectionHeader}>
                  <h3 className={styles.sectionLabel}>{t("extended.videoContent")}</h3>
                </div>
                ...
                {videos.map((vid, idx) => (
                  <div key={idx} className={styles.videoCard}>
                    ...
                    <div className={styles.videoInputGroup} style={{ marginBottom: "1rem" }}>
                      <label className={styles.videoInputLabel}>{t("extended.videoTitle")}</label>
                      <input
                        type="text"
                        required
                    ...
                    <div className={styles.videoInputGroup} style={{ marginBottom: "1rem" }}>
                      <label className={styles.videoInputLabel}>{t("extended.videoDescription")}</label>
                      <textarea
                        required
                        className={styles.videoInput}
                    ...
                    <div className={styles.videoInputGroup} style={{ marginBottom: "1rem" }}>
                      <label className={styles.videoInputLabel}>{t("extended.customThumbnailDesc")}</label>
                    ...
                    <div className={styles.videoInputGroup} style={{ marginBottom: "1rem" }}>
                      <label className={styles.videoInputLabel}>{t("extended.videoSourceType")}</label>
